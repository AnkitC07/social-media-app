...
import SkeletonComment from "../common/SkeletonComment";
const CommentArea = ({ commentsLoading, commentModal, comment, setComment }) => {
            ...
            <div className="flex flex-col justify-end">
                ...
                <div className="flex flex-col divide-y divide-[#ffffff26] ml-4 overflow-y-auto max-h-[444px]">
                    {commentsLoading
                        ...
                        : commentModal?.post?.replies?.length > 0
                ...
                <div className="flex items-start pl-4 pt-4  border-t border-[#ffffff26]">
                    <div>
                        <Profile src={userData.avatar} w={42} h={100} />
                    </div>
                    <div>
                        <textarea
