                ...
                <div className="p-4">
                    <div className="relative flex w-full">
                        ...
                        <div className="flex flex-col text-right">
                            <button className="ml-auto mr-0  flex max-h-max max-w-max items-center justify-center whitespace-nowrap rounded-full border border-blue-500 bg-transparent px-4 py-2 font-bold text-blue-500 hover:border-blue-800 hover:border-blue-800 hover:shadow-lg focus:outline-none focus:ring">
                                Edit Profile
                            </button>
                        </div>
                    </div>
