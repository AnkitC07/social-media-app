                ...
                <div className="p-4">
                    <div className="relative flex w-full">
                        ...
                        <div className="flex flex-col text-right">
                            <button className="ml-auto mr-0 flex flex max-h-max max-w-max items-center justify-center whitespace-nowrap rounded rounded-full border border-blue-500 bg-transparent px-4 py-2 font-bold text-blue-500 hover:border-blue-800 hover:border-blue-800 hover:shadow-lg focus:outline-none focus:ring">
                                Edit Profile
                            </button>
                        </div>
                    </div>
                    ...
                    <article className="duration-350 transition ease-in-out hover:bg-gray-800">
                        ...
                        <div className="pl-[75px] pr-5">
                            ...
                            <div className="flex items-center py-4">
                                <div className="duration-350 flex flex-1 items-center text-xs text-gray-400 text-white transition ease-in-out hover:text-blue-400">
                                ...
                                <div className="duration-350 flex flex-1 items-center text-xs text-gray-400 text-white transition ease-in-out hover:text-green-400">
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="mr-2 h-5 w-5">
                                        <g>
                                ...
                                <div className="duration-350 flex flex-1 items-center text-xs text-gray-400 text-white transition ease-in-out hover:text-red-600">
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="mr-2 h-5 w-5">
                                        <g>
