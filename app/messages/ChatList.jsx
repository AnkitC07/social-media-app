    ...
    return (
        <li>
            <div
                ...
                className=" relative flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none"
            >
                <img
                ...
                <div className="w-full pb-2">
                    ...
                    <span className="block ml-2 text-sm text-gray-600">{truncateText(msg, 20)}</span>
                </div>
            </div>
        </li>
    );
